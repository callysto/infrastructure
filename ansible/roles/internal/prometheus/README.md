# This role has been modified to work on CentOS / RHEL systems
# Original role only for Ubuntu-based systems can be found on Github
https://github.com/UnderGreen/ansible-prometheus.git
